...
public class loginPanel extends javax.swing.JPanel {
    ...
    private void changeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeButtonActionPerformed
        try {
            ...
            if(newPwd2.getText().trim().length()>4 || newPwd1.getText().trim().length()>4)
           { 
                if(newPwd1.getText()==newPwd2.getText())
               {
            ...
            {
                   new javax.swing.JOptionPane().showMessageDialog(this,"Password Mismatch !!! "); 
       
            }
            }
               else 
            {
        new javax.swing.JOptionPane().showMessageDialog(this,"Too short password , Password must be greater than 4 characters. "); 
            }
